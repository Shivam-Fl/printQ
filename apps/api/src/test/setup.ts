...
process.env.PRINTQ_ENVIRONMENT ??= 'test';
process.env.DATABASE_URL ??= 'postgresql://printq_test:printq_test@127.0.0.1:5432/printq_test';
process.env.DATABASE_NAMESPACE ??= 'test';
process.env.REDIS_URL ??= 'redis://127.0.0.1:6379/15';
process.env.QUEUE_NAMESPACE ??= 'printq-test';
process.env.STORAGE_NAMESPACE ??= 'printq-test';
