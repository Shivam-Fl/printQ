...
2. Configure a separately authenticated platform admin without disclosing a plaintext password; prove admin login/recovery and shop verification. `ADMIN_BOOTSTRAP_*` values are not yet set in Render.
