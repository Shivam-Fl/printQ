...
lines.push('', '---',
  '_Two reviewers, each verifying the other. GitHub does not permit the Actions token to submit',
  'a formal approval, so this is a comment — a human clicks Approve._');
